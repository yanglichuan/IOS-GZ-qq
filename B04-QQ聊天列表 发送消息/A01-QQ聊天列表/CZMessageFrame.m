...
- (void)setMessage:(CZMessage *)message
{
    ...
    //内容
    CGSize textSize =  [message.text sizeWithMaxSize:CGSizeMake(200, MAXFLOAT) fontSize:CZFontSize]; //[self sizeWithText:message.text maxSize:CGSizeMake(150, MAXFLOAT) fontSize:CZFontSize];
